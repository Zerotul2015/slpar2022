...
class RemovePublicTemplateModel
{
     ...
     * @return array
     */
    #[ArrayShape(['breadcrumb' => "|string", 'bathStyles' => "\App\Classes\ActiveRecord\Tables\BathStyle[]", 'menuCatalog' => "\App\Model\ProductsCategory[]|NULL", 'footer' => "array|mixed", 'seo' => "string[]"])]
    public static function templateSettings(string $section, int|string $indexOrUrlObject)
    {
...
//                break;
    ...
    /**
     * TODO Остался по наследству, потом убрать если будет не нужен.
