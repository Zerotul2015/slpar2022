<template>
  <div class="order-block">
    ...
    <div class="form form_row order-form order-form_customer">
      <div class="form-item form-item_row form-item_title">Данные покупателя</div>
      <div class="form-item">
      ...
      <div class="form-item" @mouseover="suggestionDisplay = true" @mouseleave="suggestionDisplay=false">
    ...
    <div class="form order-form order-form_delivery" v-if="deliveryMethods">
      <div class="form-item form-item_title">Способ доставки</div>
      <div class="form-item" v-for="(deliveryItem, keyDelivery) in deliveryMethods">
    ...
    <div class="form order-form order-form_payments" v-if="paymentsMethods">
      <div class="form-item form-item_title">Способ оплаты</div>
      <div class="form-item" v-for="(paymentItem, keyPayment) in paymentsMethods">
  ...
  methods: {
    ...
    sendOrder: function () {
      if (this.formIsFilled) {
        ...
        this.$emit('send-order', orderData)
      }
    },
  }
}
