<template>
  <div class="wrapper-content">
    ...
    <div class="buttons-block">
      <router-link class="button button_green" to="/wholesales-level/create">
    ...
    <Pagination :route-prefix="'/wholesales-level/page/'" :page-count="this.paginationPageCount"/>
...
export default {
  ...
  methods: {
    getCount() {
      ...
      api.getData('wholesalesLevel', sendData)
          .then((r) => {
