  ...
  <div class="wrapper-content">
    ...
    <div class="buttons-block">
      <router-link class="button button_green" to="/discount/create">
        ...
        <span class="button-text">Создать способ доставки</span>
      </router-link>
    </div>
    ...
    <Pagination :route-prefix="'/delivery-methods/page/'" :page-count="this.paginationPageCount"/>
...
export default {
  ...
  methods: {
    getCount() {
      ...
      api.getData('deliveryMethods', sendData)
          .then((r) => {
