  ...
  <div class="wrapper-content">
    ...
    <div class="buttons-block">
      <router-link class="button button_green" to="/discount/create">
        ...
        <span class="button-text">Создать способ оплаты</span>
      </router-link>
    </div>
    ...
    <Pagination :route-prefix="'/payment-methods/page/'" :page-count="this.paginationPageCount"/>
